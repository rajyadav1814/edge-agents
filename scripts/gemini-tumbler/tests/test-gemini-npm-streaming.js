/**
 * Test script for Gemini 2.5 Pro using the Google Generative AI SDK with streaming
 */
...
async function run() {
  ...
  try {
    ...
    // Send a message to the model with streaming
    console.log("Sending message to model with streaming...");
    const result = await chatSession.sendMessageStream("What are the main differences between Gemini and GPT models?");
