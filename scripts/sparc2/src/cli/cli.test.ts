...
Deno.test("CLI handles rollback command", async () => {
  ...
  try {
    ...
    globalThis.SPARC2Agent = class {
      async init() {}
      async rollback(...args: any[]) { rollbackSpy(...args); }
    };
...
Deno.test("CLI handles checkpoint creation", async () => {
  ...
  try {
    ...
    globalThis.SPARC2Agent = class {
      async init() {}
      async createCheckpoint(...args: any[]) { return createCheckpointSpy(...args); }
    };
...
Deno.test("CLI handles code execution", async () => {
  ...
  try {
    ...
    const executeCodeSpy = spy(() => Promise.resolve({
    ...
    globalThis.SPARC2Agent = class {
      async init() {}
      async executeCode(...args: any[]) { return executeCodeSpy(...args); }
    };
...
Deno.test("CLI handles plan and execute", async () => {
  ...
  try {
    ...
    const planAndExecuteSpy = spy(() => Promise.resolve([
      {
        path: "test.ts",
    ...
    globalThis.SPARC2Agent = class {
      async init() {}
      async planAndExecute(...args: any[]) { return planAndExecuteSpy(...args); }
    };
