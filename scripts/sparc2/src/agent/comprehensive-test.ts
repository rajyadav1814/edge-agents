...
async function runTests() {
  try {
    ...
    console.log("1. Changed diffMode type from 'file' | 'line' to 'file' | 'function' to match computeDiff");
    console.log("2. Removed default diffMode parameter in analyzeAndDiff to use the default from computeDiff");
    console.log("3. Updated rollback method to use the correct type parameter ('checkpoint' | 'temporal')");
