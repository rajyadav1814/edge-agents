...
Deno.test("index exports all expected modules and functions", () => {
  ...
  assertEquals(typeof SPARC2.createCorsPreflightResponse, "function", "createCorsPreflightResponse should be exported");
  assertEquals(typeof SPARC2.isCorsPreflightRequest, "function", "isCorsPreflightRequest should be exported");
  assertEquals(typeof SPARC2.handleCorsPreflightRequest, "function", "handleCorsPreflightRequest should be exported");
