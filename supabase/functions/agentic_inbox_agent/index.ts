...
const API_KEY = Deno.env.get("OPENROUTER_API_KEY") || Deno.env.get("VITE_OPENROUTER_API_KEY");
...
// Start an HTTP server for edge deployment. Listens for POST requests with JSON body { "query": "your question" }.
